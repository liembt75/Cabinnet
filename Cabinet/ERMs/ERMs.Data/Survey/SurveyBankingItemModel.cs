...
namespace ERMs.Data
{
    public class SurveyBankingItemModel : CR_Survey_Banking_Item
    {
        public Color TextColorValue { get; set; }
        public SurveyBankingItemModel ToCustomModel(CR_Survey_Banking_Item item)
        {
        ...
        public CR_Survey_Banking_Item ToEntityModel()
        {
            CR_Survey_Banking_Item returnValue = new CR_Survey_Banking_Item();
